...
module.exports = async (req, res) => {
  ...
  try {
    ...
    for (const subscription of records) {
      ...
      // const startDate = "2024-07-01T03:59:59.999+00:00";
      // const endDate = "2024-07-31T03:59:59.999+00:00";

      const placeId = "66aa788708b556214429133f";
      const placeData = await Place.findOne(
        { _id: ObjectId(placeId) },
        { subscriptionSurcharge: 1, userId: 1, google: 1, applyTaxOnServiceFee: 1, plivoId: 1 }
      ).populate("plivoId");
      ...
      let queryForPayment = {
        placeId: "61eececbb103efc3452a5a95",
      };
      ...
      if (!stripeCustomerId && !paymentMethodId) {
        ...
        let reservationObject = {
          ...
          licensePlate: licensePlateArrayToString(licensePlate),
