...
const RefundDialog = (props) => {
    ...
    const { dialogOpen, onClose, data, isRefundIssued, setIsRefundIssued, fullRefund, setFullRefund, getReservationsData } = props;
    ...
    const handleIssueRefund = async (payload) => {
        ...
        await dispatch(
            ...
            .then(async (res) => {
                ...
                if (success) {
                    setIsRefundIssued(!isRefundIssued)
                    getReservationsData()
                    onClose();
                }
                setIsLoading(false);
            ...
            >
                <DialogContent>
                    ...
                    <MDTypography
                        ...
                        color="text"
                    >
                        {`Transaction ID: ${get(data, "paymentId.paymentInfo.id", "NA")}`}
                    </MDTypography>
                    <MDTypography
                        display="block"
                        variant="caption"
                        ...
                        color="text"
                    >
                        {`License Plates: ${data?.licensePlate ? data?.licensePlate?.join(', ') : 'NA'}`}
                    </MDTypography>
                    <MDTypography
                        display="block"
                        variant="caption"
                    ...
                    <Formik
                        initialValues={{
                            transactionId: get(data, "paymentId.paymentInfo.id", "NA"),
                            fullRefund: false,
                            amount: "",
                            purpose : 'PARKING'
                        }}
