      ...
      <div ref={pdfRef}>
        ...
        >
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ color: "#666", marginBottom: isSubscription ? "10px" : "30px", fontSize: "14px" }}>
            ...
            <table style={{ width: "100%", fontSize: "14px", border: "0" }}>
              ...
              <tr>
                ...
                >
                  ...
                  {consolidateReceipt ?
                    (
                      get(data, "licensePlates", "").split(",").length > 8 ?
                        (
                          <div>
            ...
            <div
              style={{
                fontWeight: "bold",
                marginTop: isSubscription ? "15px" : "50px",
                marginBottom: "15px"
              }}
            >
